...
model = timesformer_hug.load_weights(model,"outputs/vesuvius/pretraining_all/vesuvius-models/TF_['rect55', 'remaining5']_valid=rect55_size=224_lr=0.0001_in_chans=16_epoch=5-v2.ckpt")
trainer = pl.Trainer(
